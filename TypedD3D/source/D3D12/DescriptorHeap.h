...
namespace TypedD3D::Internal
{
    ...
    {
        template<D3D12_DESCRIPTOR_HEAP_TYPE Type, D3D12_DESCRIPTOR_HEAP_FLAGS HeapFlags>
        using DescriptorHeap_t = ::TypedD3D::D3D12::DescriptorHeap_t<Type, HeapFlags>;
...
{
    template<D3D12_DESCRIPTOR_HEAP_TYPE Type, D3D12_DESCRIPTOR_HEAP_FLAGS HeapFlags>
    class DescriptorHeap_t : public Internal::InterfaceWrapper<ID3D12DescriptorHeap, typename Internal::D3D12::DescriptorHeap::Traits<Type, HeapFlags>::Interface>
    {
