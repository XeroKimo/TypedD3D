...
{
    template<>
    struct WrapperMapper<ID3D12Resource>
    {
        using type = ::TypedD3D::D3D12::Resource;
    };
}

namespace TypedD3D::D3D12
{
    class Resource : public Internal::InterfaceWrapper<ID3D12Resource, typename Internal::D3D12::Resource::Traits::Interface>
    {
